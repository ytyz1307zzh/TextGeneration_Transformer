...
from transformer.Translator_rand import Translator_rand
...
def main():
    ...
    parser.add_argument('-top_k', type=int, default=10,
                        help='Top k random sample: each timestep select top_k probable words')
    ...
    translator = Translator_rand(opt)
